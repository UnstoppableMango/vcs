...
export const fsharpPropertyTesting = projectIn(demosGroup, "fsharp-property-testing", {
	description: "Lightning talk for property testing in F#",
});

export const gheIac = projectIn(demosGroup, "ghe-iac", {
...
export const everybodyCodes = projectIn(demosGroup, "everybody-codes", {
...
export const pulumiImaug = projectIn(demosImaugGroup, "pulumi-imaug", {
